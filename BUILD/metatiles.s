...
; hero_velocity_x = 0;
;
L074F:	sta     _hero_velocity_x
	stx     _hero_velocity_x+1
;
; hero_x += hero_velocity_x;
;
L0683:	lda     _hero_velocity_x
	clc
	adc     _hero_x
	sta     _hero_x
...
; hero_velocity_y = 0;
;
L0755:	sta     _hero_velocity_y
	stx     _hero_velocity_y+1
;
; hero_y += hero_velocity_y;
;
L06CB:	lda     _hero_velocity_y
	clc
	adc     _hero_y
	sta     _hero_y
