...
void load_room(void){
	...
	buffer_1_mt(address, 200);
	address = get_ppu_addr(0, 96, 0);
	buffer_1_mt(address, 239); // max number on our list
	*/
	//alternate nametable address calculation, compile time constant
